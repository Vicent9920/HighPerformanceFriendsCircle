...
public class Constants {
    ...
    public final static String[] TIMES = {
            ...
            "2小时前", "3小时前", "4小时前",  "5小时前","6小时前",
            "7小时前", "8小时前", "9小时前", "10小时前","11小时前",
            "昨天", "2天前", "3天前", "5天前", "10天前",
            "半个月前", "1个月前", "2个月前", "3个月前",
            "半年前", "一年前"
    };
    public final static Long[] MILLISECONDS = {
            60L*1000,5L*60*1000,10L*60*1000,20L*60*1000,60L*60*1000,
            2L*60*60*1000,3L*60*60*1000,4L*60*60*1000,5L*60*60*1000,
            6L*60*60*1000,7L*60*60*1000,8L*60*60*1000,9L*60*60*1000,
            10L*60*60*1000,11L*60*60*1000,24L*60*60*1000,2*24L*60*60*1000,
            3L*24*60*60*1000,5L*24*60*60*1000,10L*24*60*60*1000,15L*24*60*60*1000
    };
